...
#define TypeTime_Calendar           XCTime_Calendar_t               //日历变量类型
#define TypeTime_ParamTime          XCTime_ParamTime_t              //时间参数

/*函数*/

#define Time_LeapYearJudge          XCTime_IsLeapYear               //闰年判断
#define Time_IsLeapYear             XCTime_IsLeapYear               //闰年判断
#define Time_GetLeapYearNum         XCTime_GetLeapYearNum           //计算两个年之间的闰年数量
#define Time_SetYear_CalendarToSec  XCTime_SetYear_CalendarToSec    //设置初始年,日历转秒
#define Time_SetYear_SecToCalendar  XCTime_SetYear_SecToCalendar    //设置初始年,秒转日历
#define Time_ThisYear               XCTime_TwoDateComputeDiff       //计算2个日期的差值
#define Time_TwoDateComputeDiff     XCTime_ThisYear                 //输入日期,返回今年日期的x值(x=天,时,分,秒)
#define Time_CalculateTimeDiff      XCTime_CalculateTimeDiff        //计算2个日期的差值
#define Time_CalendarToUnix         XCTime_CalendarToUnix           //由日历计算Unix时间戳
#define Time_UnixToCalendar         XCTime_UnixToCalendar           //由Unix时间戳计算日历
